...
int main(int argc, char* argv[]){
 ...
 // ------------------------------ Command Line Inputs ----------------------------------------
    ...
    // cblas_dgemm(Layout, transA, transB, M, N, K, alpha, &Matr[0], lda,  &Matr[0], lda, 1.0, &C[0][0], lda); // overwrites C
    cblas_dsymm (Layout, sideA, CblasUpper, M, N, alpha, &Matr[0], lda,  &Matr[0], lda, 1.0, &C[0][0], lda); // overwrites C
    cblas_dgemv(Layout, transA, M, N, alpha, &Matr[0], lda,  &X[0], icx, 1.0, &y[0], icy); // overwrites y
